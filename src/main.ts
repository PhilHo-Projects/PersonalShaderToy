...
let shaderLibrary: ShaderLibraryService = new HttpShaderLibraryService();

const initialRenderPreset = getRenderPreset(settings.get('render-preset', 'full-hd'));
const initialBackend = settings.get<PreviewBackend>('preview-backend', 'auto');
...
async function bootstrap() {
  ...
  outputPanel.log('Output panel ready.', 'info');
