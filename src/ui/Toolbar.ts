  ...
  constructor(
    ...
    this.el.innerHTML = `
      ...
      <div class="toolbar-right">
        ...
        <button class="tool-btn" title="Fullscreen (F11)">&#x26F6;</button>
      </div>
    `;
    ...
    // Reset
    this.el.querySelectorAll('.tool-btn')[1].addEventListener('click', () => cb.onReset());

    // Fullscreen
    this.el.querySelectorAll('.tool-btn')[2].addEventListener('click', () => cb.onFullscreen());
